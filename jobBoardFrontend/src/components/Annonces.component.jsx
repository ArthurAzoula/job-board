...
const Annonces = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4 mt-12 ml-2">
        {annonces.map((annonce) => (
          <div key={annonce.advertissement_id} className="bg-white rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition duration-300">
